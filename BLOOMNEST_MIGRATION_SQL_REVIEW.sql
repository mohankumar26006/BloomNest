-- ====================================================================
-- BLOOMNEST 2.0 CANONICAL DATABASE MIGRATION REVIEW SQL
-- TRANSACTION-SAFE, RERUNNABLE DDL SPECIFICATION
-- 
-- STATUS: PROPOSED REVIEW ARTIFACT ONLY — NOT EXECUTED
...
-- ====================================================================
-- RERUNNABLE FOREIGN KEY CONSTRAINTS VIA PG_CATALOG CHECKS
-- ====================================================================

DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'JourneyProfile_userId_fkey') THEN
    ...
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'PreconceptionCycleLog_userId_fkey') THEN
    ...
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'PreconceptionSupplementLog_userId_fkey') THEN
    ...
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'HealthVitalLog_userId_fkey') THEN
    ...
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'BloodSugarLog_userId_fkey') THEN
    ...
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'KickSession_userId_fkey') THEN
    ...
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'ContractionLog_userId_fkey') THEN
    ...
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'MedicationAdherenceLog_medicationId_fkey') THEN
    ...
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'BirthPlan_userId_fkey') THEN
    ...
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'HospitalBagItem_userId_fkey') THEN
    ...
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'MoodLog_userId_fkey') THEN
    ...
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'UserBabyNameFavorite_userId_fkey') THEN
    ...
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'MedicalReportAttachment_userId_fkey') THEN
    ...
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'ExtractedBiomarker_attachmentId_fkey') THEN
    ...
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'AgentMemory_userId_fkey') THEN
    ...
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'AgentRun_userId_fkey') THEN
    ...
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'TimelineTaskState_userId_fkey') THEN
    ...
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'AppNotification_userId_fkey') THEN
...
-- ====================================================================
-- END OF TRANSACTION-SAFE RERUNNABLE MIGRATION REVIEW SQL
-- ====================================================================
