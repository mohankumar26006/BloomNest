...
export const JourneySelectionScreen: React.FC<JourneySelectionScreenProps> = ({
  ...
  const JOURNEYS: {
  ...
  }[] = [
    {
      ...
      gradient: "bg-emerald-500/10 border-emerald-200 dark:border-emerald-900/40 opacity-80",
    },
    {
      id: "PREGNANCY",
      ...
      gradient: "bg-rose-500/15 border-rose-300 dark:border-rose-800",
    },
    {
      id: "POST_PREGNANCY",
      ...
      gradient: "bg-purple-500/10 border-purple-200 dark:border-purple-900/40 opacity-80",
    },
  ];
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 sm:p-6 bg-[#FFF7F9] dark:bg-[#120E18] text-gray-900 dark:text-rose-100">
      <motion.div
        ...
        className="w-full max-w-4xl bg-white/80 dark:bg-[#1A1523]/80 p-6 sm:p-10 rounded-2xl border border-rose-100 dark:border-rose-900/40 shadow-sm space-y-8"
      >
        {/* Header */}
          ...
          {JOURNEYS.map((item) => {
            ...
            return (
              <div
                ...
                className={`p-6 rounded-2xl border-2 transition-all cursor-pointer flex flex-col justify-between space-y-4 relative overflow-hidden ${
                  item.gradient
                } ${
                  isSelected
        ...
        <div className="pt-2 text-center max-w-xs mx-auto">
          <button
            ...
            className={`w-full py-4 rounded-2xl text-white font-bold text-sm shadow-sm flex items-center justify-center gap-2 transition-colors ${
